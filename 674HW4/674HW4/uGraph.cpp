...
void uGraph::addedge(Node *u, Node *i)
{
	Edge e;
	e.origin = u;
	e.dest = i;
...
void uGraph::remove_e(Node *n, Node *m)
{
...
void uGraph::show(string name)
{	
	ofstream outfile;
	outfile.open(name);
	if (outfile.is_open())
	{
		outfile << "strict graph G {\n";
